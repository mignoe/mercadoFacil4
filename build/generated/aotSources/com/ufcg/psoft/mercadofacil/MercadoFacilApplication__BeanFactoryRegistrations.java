...
import com.ufcg.psoft.mercadofacil.controller.ProdutoV1Controller__BeanDefinitions;
import com.ufcg.psoft.mercadofacil.repository.CarrinhoRepository__BeanDefinitions;
import com.ufcg.psoft.mercadofacil.repository.ClienteRepository__BeanDefinitions;
import com.ufcg.psoft.mercadofacil.repository.LoteRepository__BeanDefinitions;
import com.ufcg.psoft.mercadofacil.repository.ProdutoRepository__BeanDefinitions;
import com.ufcg.psoft.mercadofacil.service.CarrinhoDeComprasComprarLotePadraoService__BeanDefinitions;
import com.ufcg.psoft.mercadofacil.service.LoteAlterarPadraoService__BeanDefinitions;
import com.ufcg.psoft.mercadofacil.service.ProdutoAlterarPadraoService__BeanDefinitions;
 ...
 */
public class MercadoFacilApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("mercadoFacilApplication", MercadoFacilApplication__BeanDefinitions.getMercadoFacilApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("produtoV1Controller", ProdutoV1Controller__BeanDefinitions.getProdutoVControllerBeanDefinition());
    beanFactory.registerBeanDefinition("carrinhoDeComprasComprarLotePadraoService", CarrinhoDeComprasComprarLotePadraoService__BeanDefinitions.getCarrinhoDeComprasComprarLotePadraoServiceBeanDefinition());
    beanFactory.registerBeanDefinition("loteAlterarPadraoService", LoteAlterarPadraoService__BeanDefinitions.getLoteAlterarPadraoServiceBeanDefinition());
    beanFactory.registerBeanDefinition("produtoAlterarPadraoService", ProdutoAlterarPadraoService__BeanDefinitions.getProdutoAlterarPadraoServiceBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.LoteRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments__BeanDefinitions.getFragmentsBeanDefinition());
    beanFactory.registerBeanDefinition("loteRepository", LoteRepository__BeanDefinitions.getLoteRepositoryBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.ProdutoRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments__BeanDefinitions.getFragmentsBeanDefinition1());
    beanFactory.registerBeanDefinition("produtoRepository", ProdutoRepository__BeanDefinitions.getProdutoRepositoryBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.ClienteRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments__BeanDefinitions.getFragmentsBeanDefinition2());
    ...
    beanFactory.registerBeanDefinition("jpa.CarrinhoRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments__BeanDefinitions.getFragmentsBeanDefinition3());
    beanFactory.registerBeanDefinition("carrinhoRepository", CarrinhoRepository__BeanDefinitions.getCarrinhoRepositoryBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.flyway.FlywayAutoConfiguration$FlywayConfiguration", FlywayAutoConfiguration__BeanDefinitions.FlywayConfiguration__BeanDefinitions.getFlywayConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("resourceProviderCustomizer", FlywayAutoConfiguration__BeanDefinitions.FlywayConfiguration__BeanDefinitions.getResourceProviderCustomizerBeanDefinition());
    beanFactory.registerBeanDefinition("flyway", FlywayAutoConfiguration__BeanDefinitions.FlywayConfiguration__BeanDefinitions.getFlywayBeanDefinition());
    beanFactory.registerBeanDefinition("flywayInitializer", FlywayAutoConfiguration__BeanDefinitions.FlywayConfiguration__BeanDefinitions.getFlywayInitializerBeanDefinition());
